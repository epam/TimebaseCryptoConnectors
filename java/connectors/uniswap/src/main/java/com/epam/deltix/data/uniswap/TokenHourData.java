...
public class TokenHourData implements Updatable {
    private String id;
    private String periodStartUnix;
    ...
    @SchemaElement()
    public String getPeriodStartUnix() {
        return periodStartUnix;
    }

    public void setPeriodStartUnix(final String periodStartUnix) {
        this.periodStartUnix = periodStartUnix;
    }

    public boolean updatePeriodStartUnix(final String periodStartUnix) {
        if (Util.equals(this.periodStartUnix, periodStartUnix)) {
            return false;
        }
        this.periodStartUnix = periodStartUnix;
        return true;
    ...
    public boolean update(final JsonObject from) {
        ...
        result |= updatePeriodStartUnix(from.getString("periodStartUnix"));
