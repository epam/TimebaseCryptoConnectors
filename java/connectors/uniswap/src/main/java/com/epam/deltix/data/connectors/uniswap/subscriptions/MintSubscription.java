...
import com.epam.deltix.data.uniswap.Mint;
import com.epam.deltix.data.uniswap.MintAction;
...
public class MintSubscription extends Subscription {
    private static final GraphQlQuery.Query QUERY_TEMPLATE = GraphQlQuery.query("mints");
