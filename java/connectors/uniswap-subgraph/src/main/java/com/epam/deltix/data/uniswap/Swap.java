...
public class Swap implements Updatable {
    private String id;
    ...
    public void setSqrtPriceX96(final String sqrtPriceX96) {
        this.sqrtPriceX96 = sqrtPriceX96;
    }

    public boolean updateSqrtPriceX96(final String sqrtPriceX96) {
        if (Util.equals(this.sqrtPriceX96, sqrtPriceX96)) {
            return false;
        }
        this.sqrtPriceX96 = sqrtPriceX96;
        return true;
    ...
    public boolean update(final JsonObject from) {
        ...
        result |= updateSqrtPriceX96(from.getString("sqrtPriceX96"));
