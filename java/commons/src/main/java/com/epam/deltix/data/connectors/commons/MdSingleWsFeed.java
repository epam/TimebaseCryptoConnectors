...
public abstract class MdSingleWsFeed extends SingleWsFeed {
    ...
    protected MdSingleWsFeed(
        ...
        this(exchange, uri, depth, idleTimeoutMillis, selected, output, errorListener, periodicalJsonTask, false, symbols);
    }
    ...
    protected MdSingleWsFeed(
        ...
        super(uri, idleTimeoutMillis, selected, output, errorListener, periodicalJsonTask, skipGzipHeader, symbols);
